...
import { normalizePackageClaims, type PackageClaims } from '#package-claims/claims/PackageClaims.ts';
import { parseJsonStrict } from '#package-claims/json/CanonicalJson.ts';
