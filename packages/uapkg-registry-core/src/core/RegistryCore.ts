...
import type { RegistryCoreOptions, RegistryDescriptor } from '#registry-core/contracts/RegistryCoreTypes.ts';
import { Registry } from '#registry-core/registry/Registry.ts';
