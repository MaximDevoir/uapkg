...
import type { RegistryMetadata } from '#registry-core/contracts/RegistryCoreTypes.ts';
import { getRegistryMetadataPath } from '#registry-core/paths/RegistryPaths.ts';
